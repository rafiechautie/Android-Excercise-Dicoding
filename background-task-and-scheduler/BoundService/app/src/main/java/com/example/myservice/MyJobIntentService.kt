...
class MyJobIntentService : JobIntentService() {
    ...
    //fungsi onHandleWork akan dijalankan ketika button start_button_intent_Service ditekan
    ...
    //fungsi onDestroy akan dipanggil ketika JobIntentService dihentikan
